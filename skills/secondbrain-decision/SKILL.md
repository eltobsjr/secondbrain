...
> **Mascote:** execute `references/mascot.md` — rode o script `scripts/mascot.py decision` antes de qualquer outra resposta. Se Python não estiver disponível, use o fallback estático do mascot.md.
